...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("Fathy.CADb");
        Guard.Against.Null(connectionString, message: "Connection string 'Fathy.CADb' not found.");
